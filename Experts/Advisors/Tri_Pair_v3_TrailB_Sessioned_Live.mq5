//+------------------------------------------------------------------+
//| Tri Pair Optimized [Dynamic Risk] v3.0 — Trail B Sessioned Live |
//| Full Strategy + CSV Logging + WebRequest → Supabase             |
//| Variant: ATR trail + day-of-week AND hour session filter         |
//| For: NZDUSD H2, USDCAD H2, AUDUSD H4                           |
//|                                                                  |
...
input ulong  MagicNumber         = 123456; // SET PER PAIR: NZDUSD=1002 | USDCAD=1003 | AUDUSD=1004
